...
We used a public archive node\cite{noauthor_pokt_2024} with an initially empty local cache for the RPC calls.\todo{Write down the setup of OS, processor, RAM, disk, etc.}
