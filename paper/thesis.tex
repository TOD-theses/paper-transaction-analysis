...
Given this property, it is clear that TOD alone is not a useful vulnerability indicator. In the following, we provide some more restrictive definitions, which all are subsets of the TOD definition.
