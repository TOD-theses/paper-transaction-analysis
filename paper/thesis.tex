...
\todo{Consider moving the technical aspects to an appendix.}
...
$$\sigma \xrightarrow{T_A} \sigma_A \xrightarrow{T_{X_1}} \dots \xrightarrow{T_{X_n}} \sigma_{X_n} \xrightarrow{T_B} \sigma_B$$\todo{Should we restate it, to compare state diffs rather than states?}
